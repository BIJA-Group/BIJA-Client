...
export const SERVICES = [
  {
    ...
    bestFor: "Startups, SMEs, and established businesses that need a fast, modern web presence.",
  },
  {
    icon: "Monitor",
    title: "CRM Automations",
    slug: "crm-automations",
    short: "Connect your tools, eliminate manual data entry, and keep your pipeline moving automatically.",
    description:
      "We build custom CRM automation workflows that sync your sales pipeline, contacts, and communications, so your team spends time closing deals, not updating records.",
    features: [
    ...
    investment: "$1,200+",
    timeline: "2-5 weeks depending on CRM complexity",
    bestFor: "Sales teams spending too much time on manual data entry and follow-ups.",
  },
  {
    icon: "Palette",
    title: "Workflow Automations",
    slug: "workflow-automations",
    short: "Automate repetitive tasks across your tools so your team focuses on work that matters.",
    description:
      "We map, design, and build cross-platform workflow automations using tools like Zapier, Make, and custom APIs, eliminating manual steps and human error from your daily operations.",
    features: [
      "End-to-end workflow mapping & design",
      "Multi-app automation (Zapier, Make, n8n)",
      "Custom API integrations & webhooks",
      "Automated reporting & notifications",
    ],
    investment: "$800+",
    timeline: "1-4 weeks per workflow bundle",
    bestFor: "Operations teams with repetitive cross-platform tasks eating into their day.",
  },
  {
    icon: "Search",
    title: "Automation Audit",
    slug: "automation-audit",
    short: "A deep review of your current tools and processes to find where automation saves you the most time.",
    description:
      "We conduct a thorough audit of your existing tech stack and manual processes, then deliver a prioritised roadmap of automation opportunities ranked by time saved and ROI.",
    features: [
      "Full tech stack & process review",
      "Identification of manual bottlenecks",
      "Prioritised automation opportunity report",
      "Implementation roadmap with cost estimates",
    ],
    investment: "$500+",
    timeline: "1-2 weeks",
    bestFor: "Businesses that know they need automation but don't know where to start.",
  },
  {
    icon: "Palette",
    title: "UI/UX Design",
    ...
    bestFor: "Teams building a product who want users to love how it feels, not just how it works.",
  },
  {
    icon: "ShoppingCart",
    title: "E-Commerce",
    ...
    investment: "$2,500+",
    timeline: "5-10 weeks",
    bestFor: "Retailers and brands in Rwanda ready to sell online with real payment infrastructure.",
  },
  {
    icon: "Search",
    ...
    bestFor: "Sites that exist but aren't being found, or load too slowly to convert.",
  },
  {
    icon: "Wrench",
    ...
    bestFor: "Clients post-launch who want a reliable partner, not a one-and-done vendor.",
  },
] as const;
