        ...
        <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {PROCESS_STEPS.map(step => (
            <StaggerItem key={step.num}>
              <div className="bg-[#e0e5ec] rounded-[16px] shadow-neu-out p-8 text-center h-full hover:-translate-y-1 transition-transform duration-300">
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-full bg-[#e0e5ec] shadow-neu-in-sm text-[10px] font-semibold tracking-widest uppercase text-subtle">
                  {step.duration}
                </span>
              </div>
            </StaggerItem>
